...
Object.defineProperty(exports, "__esModule", { value: true });
var Desirability_1 = __webpack_require__(/*! ./Desirability */ "./src/core/Desirability.ts");
...
var Action = /** @class */ (function () {
    function Action(_name, _desirability, _trackingLogs) {
        ...
        if (_trackingLogs.length === 0) {
            ...
            this._duration = _trackingLogs.map(function (l) { return l.duration; }).reduce(function (prev, curr) { return prev.add(curr); });
        }
    }
    ...
    Object.defineProperty(Action.prototype, "isActive", {
    ...
    Action.from = function (object) {
        ...
        var trackingLogs = object.trackingLogs.map(function (o) { return TrackingLog_1.TrackingLog.from(o); });
...
Object.defineProperty(exports, "__esModule", { value: true });
var values = ["Good", "Neautoral", "Bad"];
function isDesirability(obj) {
    return values.includes(obj);
}
exports.isDesirability = isDesirability;
;
...
var Duration = /** @class */ (function () {
    function Duration(msecOrFromDate, toDate) {
...
var TrackingLog = /** @class */ (function () {
    function TrackingLog(start, end) {
    ...
    Object.defineProperty(TrackingLog.prototype, "duration", {
        get: function () { return new Duration_1.Duration(this._start, this._end); },
        enumerable: true,
        configurable: true
    });
    TrackingLog.prototype.toJSON = function () {
        return {
            start: this._start,
            end: this._end,
        };
    };
    TrackingLog.from = function (object) {
        if (!object.start) {
...
window.onload = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0: return [4 /*yield*/, localforage_1.default.getItem('actions')];
            case 1:
                actionsJSON = _b.sent();
                actions = actionsJSON ? JSON.parse(actionsJSON).map(function (o) { return Action_1.Action.from(o); })
                    : [];
                if (actions.length === 0) {
                    actions.push(new Action_1.Action("音楽", "Good", [])),
                        actions.push(new Action_1.Action("プログラミング", "Good", [])),
                        actions.push(new Action_1.Action("トレーニング", "Good", [])),
                        actions.push(new Action_1.Action("掃除", "Good", [])),
                        actions.push(new Action_1.Action("数学", "Good", [])),
                        actions.push(new Action_1.Action("漫画", "Neautoral", [])),
                        actions.push(new Action_1.Action("アニメ", "Neautoral", [])),
                        actions.push(new Action_1.Action("映画", "Neautoral", [])),
                        actions.push(new Action_1.Action("ポケモン", "Neautoral", [])),
                        actions.push(new Action_1.Action("ぷよぷよ", "Bad", [])),
                ...
                setInterval(function () { return __awaiter(void 0, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, localforage_1.default.setItem('actions', JSON.stringify(actions))];
                            case 1:
                                _a.sent();
                                return [2 /*return*/];
                        }
